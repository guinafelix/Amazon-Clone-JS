            ...
            <div class="order">
                <div class="order-info">
                    <div>
                        ...
                        <div>
                            ${
                                isDelivered ? `<div class="success">Entregue em ${deliveredAt}</div>` : `<div class="error">Não entregue</div>`
                            }
                        </div>
                    </div>
                    <div>
                        ...
                        ${
                            isPaid ? `<div class="success">Pago em ${paidAt}</div>` : `<div class="error">Não foi pago</div>`
                        }
                    </div>
                    <div>
